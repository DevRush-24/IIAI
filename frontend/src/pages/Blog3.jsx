...
function Blog3() {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:5001/api/secure-pdf/3", {
      ...
      <div className="min-vh-100 bg-dark text-white">
        ...
        <section className="container-fluid py-5">
          <div className="d-flex justify-content-center">
            ...
            >
              <article>
                <h1 className="fw-bold mb-3">The Development of Radiation Processing in India</h1>
                ...
                <p className="lead text-secondary">
                  A joint technical report on the above subject has been published by the International Irradiation Association (iia) in collaboration with the Irradiation Industries Association of India (IIAI)
                </p>

                <p>
                 This report outlines the progress and current state of radiation processing and irradiation technologies in India. It emphasises the initiatives undertaken by the DAE to promote this sector and facilitate technology transfer to the industry.
                </p>

                <p>
                  The informative report also provides references for further study.
                </p>
